	 				...
	 				<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description" rows="4" placeholder="Enter your description here!" class="form-control"/> 
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="unitPrice" id="unitPrice" placeholder="Enter Unit In &#8377" class="form-control" />
